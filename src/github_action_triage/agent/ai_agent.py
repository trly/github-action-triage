...
class ActionTriageAgent(RemediationAgent):
    ...
    async def diagnose_and_propose(self, context: FailureContext) -> RemediationProposal:
        ...
        sdk_mcp_server = create_sdk_mcp_server(name="triage", version="1.0.0", tools=[submit_tool])
...
Please investigate this failure and submit a remediation proposal once you have identified the root cause."""
    ...
    def _create_submit_proposal_tool(self, proposal_storage: dict[str, RemediationProposal | None]):
