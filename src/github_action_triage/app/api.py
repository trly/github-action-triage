...
class TriageResult(BaseModel):
    ...
    message: str = Field(default="", description="Human-readable message about the outcome")
...
class TriageService:
    ...
    async def process_failure_async(self, event: WorkflowRunFailureEvent) -> None:
        ...
        try:
            ...
            issue_url = await self._issue_creator.create_issue_for_proposal(event, proposal)
            logger.info(
